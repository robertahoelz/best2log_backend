...
import com.best2log.best2log.security.JWTAuthenticationFilter;
import com.best2log.best2log.security.JWTAuthorizationFilter;
import com.best2log.best2log.security.JWTUtil;
import com.best2log.best2log.security.UserDetailsServiceImpl;
...
public class ConfigSecurity extends WebSecurityConfigurerAdapter {
    ...
    public static final String[] AUTH_WHITELIST={
            "/login","/funcionario","/funcionario/redefinir/**","/funcionario/enviarCodigo/**"
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable().authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET,AUTH_BLACKLIST).denyAll()
