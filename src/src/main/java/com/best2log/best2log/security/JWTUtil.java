...
public class JWTUtil {
	...
	public String generateToken(String username) {
		return Jwts.builder().setSubject(username).setExpiration(new Date(System.currentTimeMillis() + expiracao))
				.signWith(SignatureAlgorithm.HS512, "c4f211e9-db2adf4df4f0a390-48c4-8f02-".getBytes()).compact();
	}
